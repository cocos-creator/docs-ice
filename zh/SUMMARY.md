...
- [配置信息](developer/configure/index.md)
    - [服务端配置](developer/configure/server/index.md)
        - [素材上传](developer/configure/upload/index.md)
    ...
    - [对象配置](developer/configure/object/index.md)
        ...
        - [动画配置](developer/configure/object/animation/index.md)
        - [视频配置](developer/configure/object/video/index.md)
...
- [第三方平台适配](developer/third-platform/index.md)
    ...
    - [ClassIn 适配](developer/third-platform/class-in/index.md)
